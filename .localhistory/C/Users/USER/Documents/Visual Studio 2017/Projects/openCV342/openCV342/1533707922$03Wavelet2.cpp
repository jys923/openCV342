...
int image::getim(String filePath)
{
	im = imread(filePath, 0); //Load image in Gray Scale
	...
	imr = Mat::zeros(1000, 1000, CV_32F);
	imd = Mat::zeros(1000, 1000, CV_32F);
...
//{
//	image my;
//	my.getim("./../../[00Images]/etc/lena.png");
//	return 0;
//}